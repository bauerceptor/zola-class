...
**Step 2.** Copy an existing deck as a template:
...
- Leave the `<script>` tag pulling `_themes/deck-utils.js` alone.
- Leave `Reveal.initialize({...})` alone unless you know reveal.js
  options.
